 ...
 * @param params id
 */
export async function deleteDelegation(params: { id: number }) {
 ...
 */
export async function updateDelegation(data: { id: number; name: string; url?: string }) {
...
/** 新增委托 ok*/
export async function createDelegation(data: { name: string }) {
 ...
 * 用户填表完成，提交委托
 */
export async function submitDelegation(data: { id: number }) {
...
export async function getSimpleUserByRole(params: { roleCode: string }) {
  return request<{
    code: number;
    data: {
      id: string;
...
//获得委托流程列表
export async function getProcessList(params: { id: number }) {
  return request<{
    code: number;
    data: API.DelegationProcessItem[];
    msg: string;
...
export async function saveOffer(body: { delegationId: number; data: object }) {
...
export async function submitOffer(body: { delegationId: number }) {
...
//报价的接受与拒绝
export async function acceptOffer(body: { delegationId: number }) {
...
export async function rejectOffer(body: { delegationId: number; reason: string }) {
